...
HEADERS += engine/class_modules/fs_player.hpp
...
SOURCES += engine/class_modules/fs_player.cpp
SOURCES += engine/class_modules/sc_aeona.cpp
SOURCES += engine/class_modules/sc_ardeos.cpp
SOURCES += engine/class_modules/sc_elarion.cpp
SOURCES += engine/class_modules/sc_enemy.cpp
SOURCES += engine/class_modules/sc_gunde.cpp
SOURCES += engine/class_modules/sc_mara.cpp
SOURCES += engine/class_modules/sc_rime.cpp
SOURCES += engine/class_modules/sc_tariq.cpp
SOURCES += engine/class_modules/sc_xavian.cpp
